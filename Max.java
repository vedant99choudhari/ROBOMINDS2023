...
@Autonomous(name = "Max", group = "Auto")
...
public class Max extends LinearOpMode {
    ...
    //  moveTill_Proximity();  
        ...
        {   
            ...
            //moveTill(0,7);
            color = get_block(sensor_1);
            color22 = get_block(sensor_2);
            ...
            else
            {
             ...
             moveTill_distance2(20,0);  //17
            moveTill_Proximity();
            
             drop();
              wait(0.5);
             moveTill_distance2(16,0);  //12
